...
<title>Sales Management application - edit a category</title>
				...
				<div class="container-fluid">
					<c:if test="${permission==2}">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form action="/Categories/${category.id}/editCategory/edit"
									method="post">
									<fieldset>
										<!-- Form Name -->
										<legend>Edit the category ${category.code}</legend>
										<!-- hidden input-->

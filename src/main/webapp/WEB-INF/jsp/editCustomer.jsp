...
<title>Sales Management application - edit a customer</title>
				...
				<div class="container-fluid">
					<c:if test="${permission==2}">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<form action="/Customers/${customer.id}/editCustomer/edit">
									<fieldset>
										<!-- Form Name -->
										<legend>Edit the customer ${customer.name}
											${customer.lastName}</legend>
										<!-- hidden input-->
